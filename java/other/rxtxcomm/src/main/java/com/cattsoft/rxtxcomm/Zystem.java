...
public class Zystem
{
    ...
    /**
     * Constructor.
     * Mode is taken from the java system property "com.cattsoft.rxtxcomm.log.mode". The available values are :<ul>
  ...
  {
    String s = System.getProperty ("com.cattsoft.rxtxcomm.log.mode");
    if (s != null)
      {
	...
	*/
	...
	public boolean report( String s)
	{
		...
		{
			java.util.logging.Logger.getLogger ("com.cattsoft.rxtxcomm").fine (s);
			return (true);
		}
		return( false );
	}
