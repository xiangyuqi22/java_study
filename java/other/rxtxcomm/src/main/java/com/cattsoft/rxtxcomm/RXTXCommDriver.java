...
public class RXTXCommDriver implements CommDriver
{
	...
	private final static boolean noVersionOutput = "true".equals( System.getProperty( "com.cattsoft.rxtxcomm.rxtx.NoVersionOutput" ) );
	...
	static
	{
		...
		System.out.println("RXTXVersion.loadLibrary( \"rxtxSerial\" );");
		...
		*/
		...
		String LibVersion;
		try {
				System.err.println("调用 RXTXVersion.nativeGetVersion()  ---》 开始");
		        LibVersion = RXTXVersion.nativeGetVersion();
		        System.err.println("调用 RXTXVersion.nativeGetVersion()  ---》 成功");
		} catch ( Error UnsatisfiedLinkError )
		{
			// for rxtx prior to 2.1.7
			System.err.println("调用 RXTXVersion.nativeGetVersion() ---》 失败");
			LibVersion = nativeGetVersion();
			System.err.println("调用 nativeGetVersion() ---》 成功");
		}
		if ( devel )
		{
			if ( ! noVersionOutput )
...
private void addSpecifiedPorts(String names, int PortType)
   ...
   /*
    * Register ports specified in the file "com.cattsoft.rxtxcomm.rxtx.properties"
    * Key system properties:
    *                   com.cattsoft.rxtxcomm.rxtx.SerialPorts
    * 			com.cattsoft.rxtxcomm.rxtx.ParallelPorts
    *
    * Tested only with sun jdk1.3
    * The file com.cattsoft.rxtxcomm.rxtx.properties may reside in the java extension dir,
    * or it can be anywhere in the classpath.
    *
    * Example: /usr/local/java/jre/lib/ext/com.cattsoft.rxtxcomm.rxtx.properties
    *
    * The file contains the following key properties:
    *
    *  com.cattsoft.rxtxcomm.rxtx.SerialPorts=/dev/ttyS0:/dev/ttyS1:
    *  com.cattsoft.rxtxcomm.rxtx.ParallelPorts=/dev/lp0:
    *
   ...
   private boolean registerSpecifiedPorts(int PortType)
      ...
      for (int i = 0; i < dirArray.length; i++)
         {
         String file_name = dirArray[i] + System.getProperty("file.separator") + "com.cattsoft.rxtxcomm.rxtx.properties";
      ...
      if (props == null)
         ...
         try
            {
            Enumeration resources = loader.getResources("com.cattsoft.rxtxcomm.rxtx.properties");
            ...
            if (debug)
               {
               System.out.println("RXTXCommDriver.registerSpecifiedPorts(): Error encountered while getting com.cattsoft.rxtxcomm.rxtx.properties from the classpath: " + e);
               }
            }
         }
      if (debug)
      ...
      if (props == null)
         ...
         final String serialProp = System.getProperty("com.cattsoft.rxtxcomm.rxtx.SerialPorts", null);
         final String parallelProp = System.getProperty("com.cattsoft.rxtxcomm.rxtx.ParallelPorts", null);
         if (serialProp != null || parallelProp != null)
            ...
            if (serialProp != null)
               ...
               if (debug)
                  {
                  System.out.println("RXTXCommDriver.registerSpecifiedPorts(): Found com.cattsoft.rxtxcomm.rxtx.SerialPorts property with value of [" + serialProp + "]");
                  }
               props.setProperty("com.cattsoft.rxtxcomm.rxtx.SerialPorts", serialProp);
               }
            if (parallelProp != null)
               {
               if (debug)
                  {
                  System.out.println("RXTXCommDriver.registerSpecifiedPorts(): Found com.cattsoft.rxtxcomm.rxtx.ParallelPorts property with value of [" + parallelProp + "]");
                  }
               props.setProperty("com.cattsoft.rxtxcomm.rxtx.ParallelPorts", parallelProp);
               }
            }
         }
      ...
      if (props != null)
         ...
         switch (PortType)
            ...
            case CommPortIdentifier.PORT_SERIAL:
               if ((val = props.getProperty("com.cattsoft.rxtxcomm.rxtx.SerialPorts")) == null)
                  {
                  val = props.getProperty("com.cattsoft.rxtxcomm.SerialPorts");
                  }
               break;

            case CommPortIdentifier.PORT_PARALLEL:
               if ((val = props.getProperty("com.cattsoft.rxtxcomm.rxtx.ParallelPorts")) == null)
                  {
                  val = props.getProperty("com.cattsoft.rxtxcomm.ParallelPorts");
                  }
               break;
            default:
               if (debug)
         ...
         if (debug)
            {
            System.out.println("RXTXCommDriver.registerSpecifiedPorts(): The file: com.cattsoft.rxtxcomm.rxtx.properties doesn't exist and the properties weren't specified as a system property.");
            }
         }
      if (val != null)
         {
