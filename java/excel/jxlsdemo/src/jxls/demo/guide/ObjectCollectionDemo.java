...
public class ObjectCollectionDemo {
    ...
    public static List<Employee> generateSampleEmployeeData() throws ParseException {
        ...
        employees.add( new Employee("ElsaElsaElsaElsaElsaElsaElsaElsaElsaElsaElsaElsaElsaElsaElsaElsaElsaElsaElsaElsaElsa", dateFormat.parse("1970-Jul-10"), 1500, 0.15) );
